...
registry_comuni = {
    ...
    "link": "https://www.istat.it/storage/codici-unita-amministrative/Elenco-comuni-italiani.xls",  #Permalink
...
variazioni_amministrative = {
    ...
    "column_rename": {"Denominazione Comune": TAG_COMUNE,
                      "Codice Comune formato alfanumerico": TAG_CODICE_COMUNE,
                      "Codice Unità territoriale sovracomunale": TAG_CODICE_PROVINCIA,
                      "Codice Regione": TAG_CODICE_REGIONE,
...
regex_find_frazioni = r"({}) ?(\(.+\))?(\[.+\])?(.{{0,40}}) (si trova nel comune|fa parte del comune|frazione ?(\(.+\))? ?.{{0,20}} ?(\([^.]+\))? comune|borgo del comune|quartiere del comune|località del comune) (di ?)(.+)"
